...
export default function PostBookPage() {
  ...
  function onSubmit(values: z.infer<typeof BookFormValidation>) {
  ...
  return (
    <div className="container mx-auto py-8 px-4 bg-gradient-to-b from-slate-50 to-white min-h-screen">
                            ...
                            <div className="grid grid-cols-5 gap-2">
                              {[...Array(10)].map((_, i) => (
                                <Badge
                                  ...
                                  className={`py-2 cursor-pointer hover:bg-slate-100 ${
