...
import { CompactQuestionsList } from "./components/CompactQuestionsList"
...
function YearNamePage() {
  ...
  console.log("this ishte stat of year academic", yearAcademicStat)
  ...
  // Check if mobile on mount and resize - only lg screens and above show split view
  React.useEffect(() => {
    const checkMobile = () => {
  ...
  const isActionInProgress = isEditing || isDeleting || isLoading || isFetchingNextPage
